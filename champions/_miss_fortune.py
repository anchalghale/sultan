''' Logic of ashe '''
from bot import use_ability, orb_walk, kite, poke, evade, attack, kite_minion, BotContinueException
...
def evade_champion_cb(objects: Objects, areas, abilities, attack_speed):
    ''' Evades a enemy champion '''
    use_ability(objects.closest_enemy_champion, abilities, 'e')
    use_ability(objects.player_champion, abilities, 'w')
    evade(areas)
...
CHAMPION = Champion(attack_champion_cb, poke_champion_cb,
                    kite_champion_cb, attack_turret_cb, attack_minion_cb, kite_minion_cb,
                    attack_structure_cb)
